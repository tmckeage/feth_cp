...
export class EquipmentComponent implements OnInit {
	...
	ngOnInit(): void {
		this.scannerForms = new FormGroup({
			...
			"room": new FormControl('Select', []),
			"facility": new FormControl('Select', []),
	...
	get scannerForm() { return this.scannerForms.controls; }
}